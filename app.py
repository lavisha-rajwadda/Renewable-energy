...
# ---- Improved Data Loader Block ----
data_loaded = False
try:
    data = load_data()
    data_loaded = True
except Exception:
    st.info("Please upload a valid dataset CSV to start. The default file could not be found or the format is invalid.")
...
if data_loaded:
    ...
    st.info("Project dashboard features will appear here once a valid dataset is uploaded.")
